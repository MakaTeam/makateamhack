  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col l8 status" align="center">
        <a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Has realizado más de 2 donaciones"><i class="material-icons medium azulC opaco">favorite</i></a>
        <a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Has realizado más de 10 donaciones"><i class="material-icons medium azulF ">favorite</i></a>
        <a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Has realizado más de 20 donaciones"><i class="material-icons medium rosa opaco">favorite</i></a>
        <a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Has realizado más de 30 donaciones"><i class="material-icons medium fiusha opaco">favorite</i></a>
        <a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Has realizado más de 40 donaciones"><i class="material-icons medium dorado opaco">favorite</i></a>
      </div>
    </div>
    <div class="row">
      <div class="col l12 reporte azulDegradado" align="center">
        <h1 class="reporta">¿Conoces alguna Asociación? Indícanos <u>dónde</u></h1>
      </div>
    </div>
    
    <div class="row">
      <h1 align="center">Donaciones Realizadas</h1>
